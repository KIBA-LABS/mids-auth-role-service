package com.mids.auth.customer.config;

import com.fasterxml.classmate.TypeResolver;
import com.google.common.collect.Lists;
import com.mids.auth.customer.dto.Error;
...
public class SwaggerConfig {
    ...
    public Docket productApi(TypeResolver typeResolver) {
        ...
        ApiInfo apiInfo = new ApiInfo(
                "Auth Customer-registration",
                "The Auth Customer-registration api provides end points " +
                        "to communicate to the Auth Customer-registration backend system." +
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.kiba.register"))
